    ...
    var notifastApplication = {
        emitNotification: props => function(props) {
            ...
            let notification = {
                ...
                canBeClosed: props.canBeClosed || !0
        ...
        `;
            ...
            notification.canBeClosed && (document.querySelector("#" + notification.id).insertAdjacentHTML("afterbegin", `
